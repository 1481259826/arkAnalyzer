            ...
            if (!this.mIsEditSimpleToggleLayout) {
                this.ifElseBranchUpdateFunction(0, () => {
                    ...
                    }, Column);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new ControlCenterComplexToggleLayout(this, {}, undefined, elmtId, () => { }, { page: "tests/resources/viewtree/ControlCenterComponent.ets", line: 118, col: 15 });
                        ...
                        }, { name: "ControlCenterComplexToggleLayout" });
                    }
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.width('100%');
                    ...
                    }, Column);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new ControlCenterSimpleToggleLayout(this, {
                                    mColumnCount: this.mSimpleToggleColumnCount
                                }, undefined, elmtId, () => { }, { page: "tests/resources/viewtree/ControlCenterComponent.ets", line: 121, col: 17 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        mColumnCount: this.mSimpleToggleColumnCount
...
class ControlCenterComplexToggleLayout extends ViewPU {
    ...
    purgeVariableDependenciesOnElmtId(rmElmtId) {
        this.__mComplexToggleLayout.purgeDependencyOnElmtId(rmElmtId);
        this.__style.purgeDependencyOnElmtId(rmElmtId);
    }
    aboutToBeDeleted() {
...
class ControlCenterSimpleToggleLayout extends ViewPU {
    ...
    purgeVariableDependenciesOnElmtId(rmElmtId) {
        ...
        this.__mSimpleToggleLayout.purgeDependencyOnElmtId(rmElmtId);
        this.__style.purgeDependencyOnElmtId(rmElmtId);
    }
    aboutToBeDeleted() {
    ...
    static render(count: number, parent = null) {
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new ControlCenterSimpleToggleLayout(parent ? parent : this, { mColumnCount: count }, undefined, elmtId, () => { }, { page: "tests/resources/viewtree/ControlCenterComponent.ets", line: 284, col: 5 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                            mColumnCount: count
