...
describe("export Test", () => {
    ...
    it('namespace export case', () => {
        ...
        if (stmts) {
            ...
            assert.equal(stmts[2].toString(), '%0 = @exports/exportSample.ts: _DEFAULT_ARK_CLASS.[static]z');
            assert.equal(stmts[9].toString(), '%2 = @exports/exportSample.ts: _DEFAULT_ARK_CLASS.[static]MyNameSpace');
        }
    })
