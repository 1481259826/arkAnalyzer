...
import * as validator3.StringValidator from './classes';
import * as validator3.numberRegexp from './classes';
import * as validator3.ZipCodeValidator from './classes';
import * as validator3.mainValidator from './classes';
import * as validator3.ParseIntBasedZipCodeValidator from './classes';
import validator4 from './classes';
let myValidator1 = new ZipCodeValidator();
let myValidator2 = new ZipCodeValidator();
let myValidator3 = new ZipCodeValidator();
