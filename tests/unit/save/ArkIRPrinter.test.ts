...
const CASE1_EXPECT = `class %dflt {
  ...
  export classMethodTest(): void {
    label0:
      ...
      %0 = instanceinvoke %0.<@save/basic.ts: Person.constructor(number)>(10)
      notPerson = %0
      %1 = new @built-in/node_modules/ohos-typescript/lib/lib.es2015.collection.d.ts: Map
      %1 = instanceinvoke %1.<@built-in/node_modules/ohos-typescript/lib/lib.es2015.collection.d.ts: Map.constructor()>()
      x = %1
  ...
  specialString(text: string): void {
    label0:
      ...
      this = this: @save/basic.ts: %dflt
      %0 = new @built-in/node_modules/ohos-typescript/lib/lib.es5.d.ts: RegExp
      %0 = instanceinvoke %0.<@built-in/node_modules/ohos-typescript/lib/lib.es5.d.ts: RegExp.constructor()>('\\[\\d{2,}:\\d{2}((\\.|:)\\d{2,})\\]', 'g')
      lrcLineRegex = %0
      %1 = new @built-in/node_modules/ohos-typescript/lib/lib.es5.d.ts: RegExp
      %1 = instanceinvoke %1.<@built-in/node_modules/ohos-typescript/lib/lib.es5.d.ts: RegExp.constructor()>('\\[\\d{2,}', 'i')
      lrcTimeRegex1 = %1
      %2 = new @built-in/node_modules/ohos-typescript/lib/lib.es5.d.ts: RegExp
      %2 = instanceinvoke %2.<@built-in/node_modules/ohos-typescript/lib/lib.es5.d.ts: RegExp.constructor()>('\\d{2}\\.\\d{2,}', 'i')
      lrcTimeRegex2 = %2
